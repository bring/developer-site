(function($) {
  ...
  var specialistsWithProductsTable;

  var methods = {
    init: function(optionsArg) {
      $.extend(options, optionsArg);
      additionalServicesTable = $('.additional-services-view');
      specialistsWithProductsTable = $('.products-for-specialist-view');
    ...
    performXmlRequest: function(responseElement, urlArg) {
      ...
      $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
          ...
          if(data['specialistsWithProducts']) {
            that.formatSpecialistsWithProductsTable(data);
          }
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          methods.failedRequestCallback(responseElement, jqXHR, textStatus, errorThrown)
        }
      });
    },
    ...
    performJsonRequest: function(responseElement, urlArg) {
      ...
      $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
          ...
          if (data['specialistsWithProducts']) {
            that.formatSpecialistsWithProductsTable(data['specialistsWithProducts']);
          }
    ...
    formatSpecialistsWithProductsTable : function(data) {
      $.each(data, function(key) {
