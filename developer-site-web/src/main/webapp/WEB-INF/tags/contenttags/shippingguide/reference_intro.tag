...
<ul>
  <li>
      <b>Response type:</b> By querying <a
            href="https://api.bring.com/shippingguide/products/price.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;weightInGrams=1500"
            target="_blank"><code>price.${suffix}</code></a> you will get the price of the shipment, while <a
            href="https://api.bring.com/shippingguide/products/expectedDelivery.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;weightInGrams=1500"
            target="_blank"><code>expectedDelivery.${suffix}</code></a> will show you an estimated delivery time.
    By querying <a
            href="https://api.bring.com/shippingguide/products/all.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;weightInGrams=1500"
  ...
  <li>
    ...
    <a target="_blank" href="https://api.bring.com/shippingguide/products/SERVICEPAKKE/price.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;weightInGrams=1500">
    ...
    <a target="_blank" href="https://api.bring.com/shippingguide/products/price.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;weightInGrams=1500&amp;product=servicepakke&amp;product=pa_doren">
  ...
  <li>
    ...
    are not using postal codes). To specify a postal code such as "0361" add
            <a
            href="https://api.bring.com/shippingguide/products/all.${suffix}?clientUrl=insertYourClientUrlHere&from=0361&amp;to=0361&amp;weightInGrams=1500"
            ...
            href="https://api.bring.com/shippingguide/products/all.${suffix}?clientUrl=insertYourClientUrlHere&from=0361&amp;to=2100&amp;weightInGrams=1500&amp;toCountry=DK&amp;product=CARRYON_HOMESHOPPING_NORWAY"
            target="_blank"><code>&amp;toCountry=DK</code></a> or <a
            href="https://api.bring.com/shippingguide/products/all.${suffix}?clientUrl=insertYourClientUrlHere&from=2100&amp;to=0361&amp;weightInGrams=1500&amp;fromCountry=DK&amp;product=CARRYON_HOMESHOPPING_DENMARK"
  ...
  <li>
    ...
    dimensions or volume. A weight of 1500 grams can be specified by <a target="_blank"
                                                                        href="https://api.bring.com/shippingguide/products/price.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;weightInGrams=1500"><code>
    &amp;weightInGrams=1500</code></a>, dimensions of 30cm x 40cm x 40cm as <a target="_blank"
                                                                               href="https://api.bring.com/shippingguide/products/price.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;length=30&amp;width=40&amp;height=40">
    <code>&amp;length=30&amp;width=40&amp;height=40</code></a> or volume of 33dm<sup>3</sup> as <a
          target="_blank"
          href="https://api.bring.com/shippingguide/products/price.${suffix}?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;volume=33">
