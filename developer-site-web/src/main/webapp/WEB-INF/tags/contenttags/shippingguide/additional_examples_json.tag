                ...
                <div class="row element-sample">
                    <div data-tab="json" class="tab">
                        <div class="api-call">
                            <p>Request:</p>
                            <a target="_blank" class="request"
                               href="https://api.bring.com/shippingguide/products/all.json?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;volume=33&amp;date=<%=LocalDate.now()%>&amp;product=EKSPRESS09"
                               data-internal="/proxy/shipping-guide/products/all.json?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;volume=33&amp;date=<%=LocalDate.now()%>&amp;product=EKSPRESS09">
                                <pre>../products/all.json?from=7600&amp;to=1407&amp;volume=33&amp;date=<%=LocalDate.now()%>&amp;product=EKSPRESS09</pre>
                            </a>
        ...
        <div class="">
                <div data-tab="json" class="tab">
                    <div class="api-call">
                        <p>Request:</p>
                        <a target="_blank" class="request"
                           href="https://api.bring.com/shippingguide/products/all.json?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;volume=33&amp;date=<%=LocalDate.now()%>&amp;time=13:37"
                           data-internal="/proxy/shipping-guide/products/all.json?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;volume=33&amp;date=<%=LocalDate.now()%>&amp;time=13:37">
                            <pre>../all.json?from=7600&amp;to=1407&amp;volume=33&amp;date=<%=LocalDate.now()%>&amp;time=13:37</pre>
                        </a>

                        <p class="right">JSONP Request: <a
                                href="https://api.bring.com/shippingguide/products/all.json?clientUrl=insertYourClientUrlHere&from=7600&amp;to=1407&amp;volume=33&amp;date=<%=LocalDate.now()%>&amp;time=13:37&amp;callbackUrl=functionName">?callback=functionName</a>
                        </p>
                        <p>Response:</p>
                        <pre class="code-box json response delay-snippet"></pre>
                    </div>
