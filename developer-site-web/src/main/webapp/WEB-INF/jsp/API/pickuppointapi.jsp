        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                ...
                <div class="box">
                    ...
                    <p>If you want to return only the pickup points open on specified days, you may add <code>?openingHoursSearchType=&lt;day&gt;</code> to the request.</p>
                    <p><code>&lt;day&gt; = ALL_WEEKDAYS (default) | MONDAY | TUESDAY | WEDNESDAY | THURSDAY | FRIDAY | SATURDAY | SUNDAY</code></p>
                    <p> If you want you can also add openOnOrBefore and / or openOnOrAfter, to limit the search even more.</p>
                    ...
                    <p>If you want to return only the pickup points open on specific hours, you may add <code>?openOnOrBefore=&lt;time&gt;</code> and/or <code>?openOnOrAfter=&lt;time&gt;</code> to the request.</p>
