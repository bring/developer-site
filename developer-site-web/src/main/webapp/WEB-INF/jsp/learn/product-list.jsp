                ...
                <div class="article">
					...
					<table class="productlist">
                    	...
                    	<c:forEach items="${productList.products}" var="product" >
							<tr>
								...
								<td><a target="_blank" href="http://fraktguide.bring.no/fraktguide<c:out value="${fn:replace(product.codeLink, '***DATESTRING***', today)}" />"><code><c:out value="${product.code}" /></code></a></td>
								<td><a target="_blank" href="http://fraktguide.bring.no/fraktguide<c:out value="${fn:replace(product.priceLink, '***DATESTRING***', today)}" />"><c:out value="${product.price ? 'Yes' : 'No'}" /></a></td>
								<td><a target="_blank" href="http://fraktguide.bring.no/fraktguide<c:out value="${fn:replace(product.expectedDeliveryLink, '***DATESTRING***', today)}" />"><c:out value="${product.expectedDelivery ? 'Yes' : 'No'}" /></a></td>
							</tr>
                    	</c:forEach>
						</tbody>
					</table>
					...
					<table class="productlist">
                    	...
                    	<c:forEach items="${productList.additionalService}" var="service" >
							<tr>
                                <td><a target="_blank" href="http://fraktguide.bring.no/fraktguide<c:out value="${fn:replace(service.codeLink, '***DATESTRING***', today)}" />"><c:out value="${service.code}" /></a></td>
