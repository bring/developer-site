        ...
        <section id="content">
            <div class="row-fluid">
                <div class="span9">
                    ...
                    <div class="box">
                        <div class="span5">
                            </br><h3><a name="feedback"></a>Feedback</h3>

                            <p>It is appreciated if you use getSatisfaction as a channel to get in touch with the
                                developer team. There we have the opportunity to discuss and answer potential problems
                                fast.</br></br>However, if you prefer sending us a direct message, feel free to do so
                                with the feedback form. We will try to answer as soon as possible. </p>
                        </div>
                        </br></br>
                        <div class="span7">
                            <div class="lightBorder" id="wufoo-z7x0r3"></div>
                            <script type="text/javascript">var z7x0r3;
                            (function (d, t) {
                                ...
                                s.onload = s.onreadystatechange = function () {
                                    ...
                                    try {
                                        z7x0r3 = new WufooForm();
                                        z7x0r3.initialize(options);
                                        z7x0r3.display();
                                    } catch (e) {
                                    }
                                };
