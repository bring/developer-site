...
<div class="box">
    ...
    <div class="row element-sample">
        <p><h4>Example: USING GEOGRAPHICAL COORDINATES</h4></p><p>Find pickup points based on the recipient's
        geographical coordinates, Bergen city (60.395226, 5.321725)<br/>
    </p>
    ...
    <div class="row element-sample">
        <p><h4>Example: USING ID TO RETRIEVE INFORMATION ABOUT A PICKUP POINT</h4></p><p>Retrieve more information about
        the pickup point based on its id, 121110<br/>
    </p>
...
<li>
    ...
    <div class="content-box">
        <p>If you want to return only the pickup points matching a specified string, you may add <code>?searchForText=&lt;text
            to match&gt;</code> to the request. The string in the <code>&lt;text to match&gt;</code> can be the name of
            the pickup point, its address, city, county, municipality or location. Partial matches are also
            allowed.<br/><br/>
...
<li>
    ...
    <div class="content-box">
        ...
        <p>If you want to return only the pickup points open on specified days, you may add <code>?openingHoursSearchType=&lt;day&gt;</code>to
            the request. <code>&lt;day&gt; = ALL_WEEKDAYS (default) | MONDAY | TUESDAY | WEDNESDAY | THURSDAY | FRIDAY |
                SATURDAY | SUNDAY</code><br/><br/> If you want you can also add openOnOrBefore and / or openOnOrAfter,
            to limit the search even more. </p>
...
<li>
    ...
    <div class="content-box">
        <p>If you want to return only the pickup points open on specific hours, you may add <code>?openOnOrBefore=&lt;time&gt;</code>
            and/or <code>?openOnOrAfter=&lt;time&gt;</code> to the request.<br/><br/> <code>&lt;time&gt; =
                HHMM</code><br/><br/>
        </p>
